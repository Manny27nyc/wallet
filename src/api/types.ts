...
export type SolanaAddressLookupTableEntry = components['schemas']['AddressLookupTableEntry'];
...
export type KrakenConnectProxyRequest = components['schemas']['KrakenConnectProxyRequest'];
...
export type SwapQuoteRequest = components['schemas']['SwapQuoteRequestV2'];
export type SwapQuoteAsset = components['schemas']['SwapQuoteAsset'];
export type SwapQuote = components['schemas']['SwapQuote'];
export type SwapQuoteResult = components['schemas']['SwapQuoteResultV2'];
...
export type VaultInfo = components['schemas']['Result_VaultInfoResult_']['content'];
export type VaultHistoricalMetrics = components['schemas']['VaultHistoricalMetricsResult']['data'];
export type VaultTransactions = components['schemas']['VaultTransactionsResult']['transactions'];
export type VaultTransaction = VaultTransactions[number];
